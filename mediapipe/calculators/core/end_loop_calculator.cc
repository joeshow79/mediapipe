...
// typedef EndLoopCalculator<std::vector<std::string>>
typedef EndLoopCalculator<std::vector<::mediapipe::GestureText>>
    EndLoopStringVectorCalculator;
REGISTER_CALCULATOR(EndLoopStringVectorCalculator);
